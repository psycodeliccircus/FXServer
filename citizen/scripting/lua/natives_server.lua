...
function Global.CreateObject(modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic)
	return _in(0x2f7aa05c, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic, _r, _ri)
end
...
function Global.CreateObjectNoOffset(modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic)
	return _in(0x58040420, _ch(modelHash), x, y, z, isNetwork, thisScriptCheck, dynamic, _r, _ri)
end
...
function Global.CreatePed(pedType, modelHash, x, y, z, heading, isNetwork, thisScriptCheck)
	return _in(0x389ef71, pedType, _ch(modelHash), x, y, z, heading, isNetwork, thisScriptCheck, _r, _ri)
end
...
function Global.CreatePedInsideVehicle(vehicle, pedType, modelHash, seat, isNetwork, thisScriptCheck)
	return _in(0x3000f092, vehicle, pedType, _ch(modelHash), seat, isNetwork, thisScriptCheck, _r, _ri)
end
